...
public class ControlCode {
    ...
    * @param dTransaction fecha de transaccion de la forma: 2007/07/02 a
    * 20070702
   ...
   public String generate(String aNumber, String iNumber, String nitci,
      ...
      for (int i = 0; i < ary.length; i++) {
         if (ary[i].equals("")) {
            numbers[i] = Integer.valueOf("0");
         } else {
            numbers[i] = Integer.parseInt(ary[i]) + 1;
         }
      }

      String string1 = dosageKey.substring(0, numbers[1]);
      String string2 = dosageKey.substring(numbers[1], numbers[1] + numbers[2]);
      String string3 = dosageKey.substring(numbers[1] + numbers[2], numbers[1] + numbers[2] + numbers[3]);
      String string4 = dosageKey.substring(numbers[1] + numbers[2] + numbers[3], numbers[1] + numbers[2] + numbers[3] + numbers[4]);
      String string5 = dosageKey.substring(numbers[1] + numbers[2] + numbers[3] + numbers[4], numbers[1] + numbers[2] + numbers[3] + numbers[4] + numbers[5]);
      ...
      int tmp1 = totalAmount * sp1 / numbers[1];
      int tmp2 = totalAmount * sp2 / numbers[2];
      int tmp3 = totalAmount * sp3 / numbers[3];
      int tmp4 = totalAmount * sp4 / numbers[4];
      int tmp5 = totalAmount * sp5 / numbers[5];
