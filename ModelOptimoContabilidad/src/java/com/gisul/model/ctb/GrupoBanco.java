 ...
 */
@Entity
@Table(name = "opt.ctb_grupo_bancos")
public class GrupoBanco implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final GrupoBanco other = (GrupoBanco) obj;
    ...
    public String toString() {
        return "GrupoBanco{" + "idgrupo=" + idgrupo + ", empresa=" + empresa + ", nombre=" + nombre + ", estado=" + estado + ", fechaAlta=" + fechaAlta + ", usuarioAlta=" + usuarioAlta + ", fechaModificacion=" + fechaModificacion + ", usuarioModificacion=" + usuarioModificacion + ", fechaBaja=" + fechaBaja + ", usuarioBaja=" + usuarioBaja + '}';
    }
